...
const Category = () => {
  return (
    <Container className="mt-10 ">
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 mt-5 gap-5">
        <div className="w-[180px] text-center cursor-pointer">
          <div className="bg-[#d4e3ff] h-[180px] w-[180px] rounded-full flex items-center justify-center">
            <Image src={img1} alt="category one" className="" />
          </div>
          <div>
        ...
        <div className="w-[180px] text-center cursor-pointer">
          <div className="bg-[#d4e3ff] h-[180px] w-[180px] rounded-full flex items-center justify-center">
            <Image src={img2} alt="category one" className="" />
          </div>
          <div>
        ...
        <div className="w-[180px] text-center cursor-pointer">
          <div className="bg-[#d4e3ff] h-[180px] w-[180px] rounded-full flex items-center justify-center">
            <Image src={img3} alt="category one" className="" />
          </div>
          <div>
        ...
        <div className="w-[180px] text-center cursor-pointer">
          <div className="bg-[#d4e3ff] h-[180px] w-[180px] rounded-full flex items-center justify-center">
            <Image src={img4} alt="category one" className="" />
          </div>
          <div>
        ...
        <div className="w-[180px] text-center cursor-pointer">
          <div className="bg-[#d4e3ff] h-[180px] w-[180px] rounded-full flex items-center justify-center">
            <Image src={img5} alt="category one" className="" />
          </div>
          <div>
      ...
      <div className="mt-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mx-auto ">
        <div className="flex items-center justify-center gap-3 bg-[#dce8ff]/60 w-[280px] h-[100px]">
          <CiDeliveryTruck size={40} className="text-red-500" />
          <div>
        ...
        <div className="flex items-center justify-center gap-3 bg-[#dce8ff]/60 w-[280px] h-[100px]">
          <LuDollarSign size={40} className="text-red-500" />
          <div>
            <h3 className="text-md font-semibold">Free Delivary</h3>
            <p className="text-sm text-gray-600">Orders form all item</p>
          </div>
        ...
        <div className="flex items-center justify-center gap-3 bg-[#dce8ff]/60 w-[280px] h-[100px]">
          <CiDiscount1 size={40} className="text-red-500" />
          <div>
            <h3 className="text-md font-semibold">Free Delivary</h3>
            <p className="text-sm text-gray-600">Orders form all item</p>
          </div>
        ...
        <div className="flex items-center justify-center gap-3 bg-[#dce8ff]/60 w-[280px] h-[100px]">
          <FiHeadphones size={40} className="text-red-500" />
          <div>
            <h3 className="text-md font-semibold">Free Delivary</h3>
            <p className="text-sm text-gray-600">Orders form all item</p>
          </div>
